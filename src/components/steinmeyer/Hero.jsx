      ...
      <div className="relative z-10 h-full flex flex-col justify-end pb-16 md:pb-24 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          <div>
            ...
            <p className="font-body text-[#FDFCF8]/80 text-base md:text-lg max-w-xl leading-relaxed">A Romanesque Revival masterwork by Ferry & Clas, standing at the crossroads of Milwaukee's commercial heritage and its modern future.
